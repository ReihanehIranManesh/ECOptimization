(ns propeller.problems.balanced-parenthesis-classification
"Title: Balanced Parenthesis Classification
Created by: Esteban Sanchez
Description: Given a string of parenthesis, return true if it is a balanced Else return false."
  {:doc/format :markdown}
...
(def train-and-test-data
  ...
  (let [train-inputs ["(" ")" "()" "(((())))" "(((()))))" ")(()" "(((()((())))))))"]
        test-inputs ["(())" ")((((((()))))))" "(((((((((()))))))))))" "(((((())))))" "()" "((((()))))(" "((((((((()))))))))"]
        train-outputs [false false true true false false false]
        test-outputs [true false false  true true false true]]
