(ns propeller.problems.contains-subset-classification
...
(def train-and-test-data
  ...
  (let [train-inputs [["racecar" "car"] ["rod" "ro"] ["aaaab", "bcdab"] ["ragtime", "time"] ["bolster", "rapture"]
                      ["battery", "tery"] ["cato", "bot"]]
        test-inputs [["aaba", "aa"] ["random", "random"] ["coat", "kite"] ["card", "te"] ["card", "ard"]
                     ["babb", "bc"] ["caliber, " "lib"]]
