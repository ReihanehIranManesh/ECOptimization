...
(def train-and-test-data
  ...
  (let [train-inputs [["aa", "aa", "aabb"] ["racecar","race", "rack"] ["not", "nate", "nack"] 
                      ["bob", "bottle", "boot"] ["aaaaababbbb", "aa", "abbba"] ["babbab", "bat", "battle"] ["cat", "cucumber", "code"]]
        test-inputs [["aa", "aaab", "aacbcdf"] ["racecar", "random", "raid"] ["racecare", "buy", "kite"] ["card", "basket", "decoy"] 
                     ["carddrac", "card", "cab"] ["aaaaab", "babb", "abbc"] ["ccc", "ccaliber, ""cceaser"]]
